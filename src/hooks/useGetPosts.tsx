...
// 게시물을 불러오는 함수
const fetchPosts = async (menu: string, ord: OrdKey): Promise<Post[]> => {
...
export const useGetPosts = (menu: string, ord: OrdKey) => {
  ...
  const {
    ...
    ['posts', menu, ord], // 쿼리 키: menu와 ord에 따라 캐시를 구분합니다.
    () => fetchPosts(menu, ord), // 데이터 패칭 함수
    {
